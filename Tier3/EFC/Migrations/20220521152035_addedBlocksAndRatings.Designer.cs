...
namespace EFC.Migrations
{
    ...
    [Migration("20220521152035_addedBlocksAndRatings")]
    partial class addedBlocksAndRatings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Rate", b =>
                {
                    ...
                    b.HasKey("RatedUsername", "RatingUsername");
            ...
            modelBuilder.Entity("Entities.Models.Rate", b =>
                {
                    b.HasOne("Entities.Models.User", "RatedUser")
                        .WithMany()
                        .HasForeignKey("RatedUsername")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.User", "RatingUser")
                        .WithMany()
                        .HasForeignKey("RatingUsername")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
