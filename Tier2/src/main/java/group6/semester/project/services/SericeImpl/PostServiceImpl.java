...
@Service public class PostServiceImpl implements PostService
{
   ...
   */
  @Override public Post addPost(Post post, int subCategoryId)
  {
    ...
    System.out.println("At post service " + post.getDescription() + "title :"
        + post.getTitle());
  ...
  @Override public void addImage(MultipartFile file) throws IOException
  {
